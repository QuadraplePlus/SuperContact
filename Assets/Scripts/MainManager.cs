...
public class MainManager : MonoBehaviour
{
    ...
    public void PresentViewManager(ViewManager viewManager, bool isAnimated=false)
    {
        ...
        viewManager.GetComponent<RectTransform>().localScale = Vector2.one;
        ...
        if (viewManager.rightNavgationViewButton)
        {
            ...
            viewManager.rightNavgationViewButton.GetComponent<RectTransform>().sizeDelta
                = Vector2.zero;
            viewManager.rightNavgationViewButton.GetComponent<RectTransform>().localScale
                = Vector2.one;
        }
    ...
    public void DismissViewManager(bool isAnimated = false)
    {
        ...
        if (lastViewManager.rightNavgationViewButton && lastViewManager.leftNavgationViewButton)
        {
